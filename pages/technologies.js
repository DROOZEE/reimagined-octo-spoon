...
import {SectionTechnologiesStack} from '../components/sectionTechnologyStack'
		...
		return (
			<Fragment>
				...
				<Main
					...
					<SectionTechnologiesStack />

					<RegularCenterer>
						<TextWrapLast>
							<TextWrapText>Meet <Link href="/team"><TextWrapLink className="faces-link">our team!</TextWrapLink></Link></TextWrapText>
						</TextWrapLast>
					</RegularCenterer>
